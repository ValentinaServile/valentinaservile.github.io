...
This will work also on OSX, although you will need to install and start the [X11 server](https://www.xquartz.org/) on your Mac first.
...
Once these 2 pre conditions are met, you can run the SSH client with the `-X` option, which activates the X11 forwarding over the secure channel:
